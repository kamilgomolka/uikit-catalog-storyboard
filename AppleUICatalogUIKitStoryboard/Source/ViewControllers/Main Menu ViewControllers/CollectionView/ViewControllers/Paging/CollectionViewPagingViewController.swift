...
class CollectionViewPagingViewController: UIViewController {
    ...
    func setupCollectionView() {
        ...
        collectionView.register(
            UINib(nibName: BigNumberCollectionViewCell.nibName, bundle: nil),
            forCellWithReuseIdentifier: BigNumberCollectionViewCell.nibName)

        collectionView.register(
            UINib(nibName: CollectionHeaderView.nibName, bundle: nil),
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        guard
            let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: BigNumberCollectionViewCell.nibName, for: indexPath)
